...
class DNS {
    ...
    var $entries = ""; // inputs to zonefiles(.db)
    ...
    function processAddqueue() {
        ...
        if($query->numRows() > 0 ) {
            ...
            $this->raiseError("Addqueue: Nothing to process\n");
            return false;
        }
    ...
    function processDelqueue() {
        ...
        if($query->numRows() > 0 ) {
            ...
            $this->raiseError("Delqueue: Nothing to process\n");
            return false;
        }
    }
    ...
    function processModqueue() {
        ...
        if($query->numRows() > 0 ) {
            ...
            $this->raiseError("Modqueue: Nothing to process\n");
            return false;
        }
    }
